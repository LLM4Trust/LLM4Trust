...
def parameter_parser():
    ...
    parser = argparse.ArgumentParser(description = "Run Guardian.")
    ...
    parser.add_argument("--nolink-size",
                        type = int,
                        default = 0,
                        help = "Nolink edges/linked edges when computing loss. Default is 1")
    ...
    parser.set_defaults(layers = [32,64,32])
