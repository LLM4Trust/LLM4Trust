...
def parameter_parser():
    ...
    parser.add_argument("--edge-path",
                        nargs="?",
                        default="../data/bitcoinotc-rating.txt",  # bitcoinalpha-rating.txt  bitcoinotc-rating.txt
                        help="Edge list txt.")

    parser.add_argument("--data_path",
                        nargs="?",
                        default="../data/bitcoinotc.csv",  # bitcoinalpha.csv  bitcoinotc.csv
                        help="Original dataset that covers time information.")
    parser.add_argument("--train_path",
                        nargs="?",
                        default="../data/bitcoinotc-80.csv",  # bitcoinalpha-80.csv  bitcoinotc-80.csv
                        help="Original dataset that covers time information.")
    ...
    parser.add_argument("--train_time_slots",
                        type=float,
                        default=10,  # set as 2 to make sure that we have at least two snapshots for learning temporal patterns
    ...
    parser.add_argument("--attention_head",
                        type=int,
                        default=8,  # 8 for BitcoinOTC, 16 for BitcoinAlpha
